%%%%%%%%%%%%%%%% CONFIGURAÇÕES DO TEMPLATE DO SBPO
  ...
  \begin{resumo}
    ...
    %%%TABELA
      \pgfplotstabletypeset[
        ...
        columns/tempo/.style={column name = Tempo (s)},
        columns/speedup/.style={column name = Speedup},
        columns/eficiencia/.style={column name = Eficiência},
      ]{data.txt}
    ...
    %%%GRAFICO
      ...
      \begin{axis}[
          ...
          legend entries={Tempo,Speedup,Eficiência},
          ]
        \addplot table [x=threads,y=tempo] {data.txt};
        \addplot table [x=threads,y=speedup] {data.txt};
        \addplot table [x=threads,y=eficiencia] {data.txt};
      \end{axis}
      \end{tikzpicture}
      \caption{Experimentos MPI}
      \label{fig:Experimentos MPI}
      \end{figure}
